        ...
        <div className="flex justify-between items-center py-3 md:justify-start md:space-x-10">
          ...
          <nav className="hidden md:flex space-x-8">
            <div className="relative group">
              <button 
                className="text-slate-700 hover:text-blue-600 transition-colors font-medium relative group flex items-center gap-1" 
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0 gap-4">
            <Button className="bg-gradient-to-r from-blue-500 via-cyan-500 to-blue-600 hover:from-blue-600 hover:via-cyan-600 hover:to-blue-700 shadow-lg hover:shadow-xl transition-all duration-300 font-semibold" asChild>
        ...
        <div className="md:hidden bg-white/95 backdrop-blur-xl border-t border-slate-200/50 p-6 animate-fade-in shadow-lg">
          <nav className="flex flex-col gap-6">
            ...
            <div className="pt-4 border-t border-slate-200">
              <Button className="w-full bg-gradient-to-r from-blue-500 via-cyan-500 to-blue-600 hover:from-blue-600 hover:via-cyan-600 hover:to-blue-700 shadow-lg font-semibold" asChild>
                <Link to="/admin-login">Admin Login</Link>
              </Button>
            </div>
          </nav>
