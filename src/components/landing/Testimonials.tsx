...
export default function Testimonials() {
  return (
    <div className="bg-neutral-50 py-16 sm:py-20 md:py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="mx-auto mt-12 sm:mt-16 md:mt-20 grid max-w-6xl grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-3">
              ...
              <CardContent className="p-6 sm:p-8 relative">
                <div className="flex items-center mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <svg key={i} className="w-4 h-4 sm:w-5 sm:h-5 text-vibrant-400 fill-current" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  ))}
                </div>
                <p className="text-neutral-700 italic mb-6 sm:mb-8 text-sm sm:text-base lg:text-lg leading-relaxed font-normal">"{testimonial.text}"</p>
                <div className="flex items-center">
                  <Avatar className="h-10 w-10 sm:h-12 sm:w-12 mr-3 sm:mr-4 ring-2 ring-vibrant-100">
                    <AvatarFallback className="bg-gradient-to-r from-vibrant-500 to-vibrant-600 text-white font-semibold text-sm sm:text-base">{testimonial.avatar}</AvatarFallback>
                  </Avatar>
                  <div>
                    <div className="font-semibold text-neutral-900 text-base sm:text-lg font-display">{testimonial.author}</div>
                    <div className="text-neutral-600 font-normal text-sm sm:text-base">{testimonial.role}</div>
                  </div>
                </div>
              </CardContent>
            </Card>
