...
export default function CTASection() {
  return (
    <div className="bg-gradient-to-r from-blue-600 via-cyan-600 to-blue-700 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40 relative">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold tracking-tight text-white leading-tight">
            Ready to scale your
            <span className="block bg-gradient-to-r from-blue-300 to-cyan-300 bg-clip-text text-transparent">global workforce?</span>
          </h2>
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-blue-400/20 to-cyan-600/20 rounded-full blur-3xl" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-cyan-400/20 to-blue-600/20 rounded-full blur-3xl" />
    </div>
  );
}
