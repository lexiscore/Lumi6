...
export default function CTASection() {
  return (
    <div className="bg-gradient-to-r from-emerald-600 via-lime-600 to-green-700 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40 relative">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold tracking-tight text-white leading-tight">
            Ready to scale your
            <span className="block bg-gradient-to-r from-emerald-300 to-lime-300 bg-clip-text text-transparent">global workforce?</span>
          </h2>
          <p className="mx-auto mt-8 max-w-2xl text-xl leading-8 text-emerald-100">
          ...
          <div className="mt-12 flex items-center justify-center gap-6 flex-wrap">
            <Button size="lg" variant="secondary" className="px-8 py-4 text-lg font-semibold bg-white text-emerald-700 hover:bg-emerald-50 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1" asChild>
          ...
          <div className="mt-16 flex items-center justify-center gap-12 text-emerald-200 flex-wrap">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-emerald-400/20 to-lime-600/20 rounded-full blur-3xl" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-lime-400/20 to-green-600/20 rounded-full blur-3xl" />
    </div>
  );
}
