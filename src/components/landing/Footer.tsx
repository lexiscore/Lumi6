            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" className="mt-4 space-y-4">
                  ...
                  <li>
                    <a href="#" className="text-sm text-gray-400 hover:text-white">How It Works</a>
                  </li>
                  <li>
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul role="list" className="mt-4 space-y-4">
                  <li>
                    <a href="#" className="text-sm text-gray-400 hover:text-white">CEFR Guide</a>
                  </li>
                  <li>
                    <a href="#" className="text-sm text-gray-400 hover:text-white">Blog</a>
                  </li>
                  <li>
                    <a href="#" className="text-sm text-gray-400 hover:text-white">Language Tools</a>
                  </li>
                  <li>
                    <a href="#" className="text-sm text-gray-400 hover:text-white">Research</a>
                  </li>
                </ul>
              </div>
            </div>
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" className="mt-4 space-y-4">
                  ...
                  <li>
                    <a href="#" className="text-sm text-gray-400 hover:text-white">Team</a>
                  </li>
                  <li>
                    <a href="#" className="text-sm text-gray-400 hover:text-white">Partners</a>
                  </li>
                  <li>
